            ...
            <div class="login-content">
                ...
                <el-form :model="loginForm" label-width="100px"
                    ...
                    <el-form-item label="" prop="roleId">
                        <el-radio v-model="loginForm.roleId" label="2">学生</el-radio>
                        <el-radio v-model="loginForm.roleId" label="1">教师</el-radio>
                        <el-radio v-model="loginForm.roleId" label="0">管理员</el-radio>
                    </el-form-item>
                    <el-form-item>
